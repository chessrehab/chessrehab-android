...
public class FragmentGameFinished extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v= inflater.inflate(R.layout.fragment_finished_games,container,false);
        myRV= (RecyclerView) v.findViewById(R.id.rvFinGames);
        myRV.setAdapter(null);
        alFinished = new ArrayList<Game>();
        queryFinGames();

        return v;
    }
    private void queryFinGames() {
                    ...
                    public void onResponse(String Response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jArray.length(); i++) {
                                ...
                                alFinished.add(toAdd);

                            }
                            fillRecyclerFinishedGames();
    ...
    public void fillRecyclerFinishedGames() {

        myRV.setHasFixedSize(true);
        myRV.setLayoutManager(new LinearLayoutManager(getActivity()));
        myAdapter= new rvAdapter( alFinished,getActivity());
